...
button_subtraction = tk.Button(root, text= "-", command= lambda: add_to_calculator("-"), width= 5, font=("Arial", 14))
button_subtraction.grid(row=3, column=4)

button_mutiplication = tk.Button(root, text= "*", command= lambda: add_to_calculator("*"), width= 5, font=("Arial", 14))
button_mutiplication.grid(row=4, column=4)

button_division = tk.Button(root, text= "/", command= lambda: add_to_calculator("/"), width= 5, font=("Arial", 14))
